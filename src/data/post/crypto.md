...
excerpt: "각 나라들이 수많은 언어를 사용하는 것처럼, 대부분 나라들은 그들의 화폐를 사용하고 있다. 이런 경향은 국가간 무역을 수행함에 있어 환율의 변화에 따른 위험으로 인한 적지 않은 혼란을 주는 것 처럼 보인다. 만약 하나의 화폐로 통합되는 경우, 세계 시민으로써 우리는 사람들간의 화합과 통일된 세계가 되어 우리에게 많은 편익을 줄 것이라는 생각도 한다."
