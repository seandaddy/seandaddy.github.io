---
publishDate: 2026-04-11T12:00:00Z
title: "Daily Market Report - April 11, 2026"
...
**Report Generated:** April 11, 2026, 04:03 PM   
...
US markets declined on Saturday, 2026-04-11, with the Nasdaq leading at -0.56%. Meanwhile, Korean markets continued recovery.
...
3. **Won Weakens** - KRW +0.37%
4. **Treasury Yields** - 10Y at 4.29%
...
|-------|--------|-------|--------|----------|--------|
| **Apple** | AAPL | $260.49 | -0.01 | **-0.0%** | 🟡 |
| **Microsoft** | MSFT | $373.07 | -2.2 | **-0.59%** | 🔴 |
| **Alphabet** | GOOGL | $318.49 | -1.23 | **-0.39%** | 🔴 |
| **Amazon** | AMZN | $233.65 | +4.73 | **+2.02%** | 🟢 |
| **NVIDIA** | NVDA | $183.91 | +4.83 | **+2.63%** | 🟢 |
| **Meta** | META | $628.39 | +1.47 | **+0.23%** | 🟢 |
| **Tesla** | TSLA | $345.62 | +3.38 | **+0.98%** | 🟢 |

**Daily Analysis:**

The Magnificent 7 showed mostly positive results with 4 stocks advancing. NVDA led with +2.63% change. MSFT lagged at -0.59%.
...
|-------|-------|--------|----------|-------|
| **S&P 500** | 6,816 | -7.78 | **-0.11%** | 🔴 |
| **Nasdaq** | 22,902 | +80.48 | **+0.35%** | 🟢 |
| **Dow Jones** | 47,916 | -269.41 | **-0.56%** | 🔴 |

### Korean Indices

| Index | Close | Change | % Change | Trend |
|-------|-------|--------|----------|-------|
| **KOSPI** | 5,858.87 | +80.86 | **+1.4%** | 🟢 |
| **KOSDAQ** | 1,093.63 | +17.63 | **+1.64%** | 🟢 |

**Analysis:**

US markets experienced a decline with the Nasdaq leading at +0.35%. Korean markets continued recovery with KOSDAQ gaining +1.64%.
...
|-------|--------|-------|--------|----------|-------|
| **Samsung** | 005930 | ₩206,000 | +2000.0 | **+0.98%** | 🟢 |
| **SK Hynix** | 000660 | ₩1,027,000 | +29000.0 | **+2.91%** | 🟢 |
| **Hyundai** | 005380 | ₩489,500 | +0.0 | **0.0%** | 🟡 |
...
### Saturday, April 11, 2026: Global Market Rally

**Market Action:**
- 🇺🇸 Nasdaq +0.35%, S&P -0.11%, Dow -0.56%
- 🇺🇸 NVDA +2.63%
- 🇰🇷 KOSPI +1.4%, KOSDAQ +1.64%
- 💱 KRW +0.37% (strength)
...
**US Markets:**
- **S&P 500:** Support 6,612 | Resistance 7,021
- **Nasdaq:** Support 22,215 | Resistance 23,589
- **Dow:** Support 46,478 | Resistance 49,353
...
**The Good:**
✅ Korean market +1.4% recovery
✅ KRW +0.37% shows confidence
✅ US markets only down -0.11%, not catastrophic
✅ MSFT -0.59% relatively resilient

**The Bad:**
⚠️ Treasury yields rising (4.29%)
...
**Coverage Period:** April 11, 2026 (Saturday)  
