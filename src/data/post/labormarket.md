...
title: "개발자 노동시장"
excerpt: "개발자 또는 프로그래머는 평균 연봉이 높은 직업 중 하나이지만 개발자를 필요로 하는 기업들의 경우 그들을 채용하는 데 있어 여러가지 어려움을 호소하고 있다. 주위에 프로그램 개발에 뛰어난 사람들 또는 능력있는 사람은 많아 보이는 데도 불구하고 직장을 쉽게 구하는 것 같아 보이진 않는다. 경제학 용어로 요약해 보자면 노동시장의 비효율성 문제라고 할 수 ..."
category: "Economics"
tags: ["labor"]
---
