...
title: '탄력성과 그 응용'
excerpt: '경제학에서 탄력성은 다양하게 응용되며 앞으로 탄력성에 대한 언급이 점점 많아질 것이다. 탄력성과 비슷한 개념인 수요 곡선의 기울기는 가격이 한 단위 증가할 때 얼마 만큼의 수요량의 감소가 일어나는 지를 보여 주기 때문에 가격이나 수량의 단위가 바뀌는 경우 기울기 자체가 변화 하는 문제를 야기시킨다.'
