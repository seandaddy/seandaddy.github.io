...
**Report Generated:** April 14, 2026, 06:34 PM   
**Prepared by:** OpenClaw Market Intelligence
**US Market:** After Hours
**Korean Market:** Pre-Market
...
US markets gained on Tuesday, 2026-04-14, with the Nasdaq leading at +1.02%. Meanwhile, Korean markets continued recovery.

### Today at a Glance

**⚠️ Note: US markets are in after-hours (closed at 4PM ET). Data shown is from today's session.**

**⚠️ Note: Korean markets are in pre-market (opens 9:00 KST). Data shown is from last trading day.**
...
**Key Themes:**
3. **Won Strengthens** - KRW -0.29%
4. **Treasury Yields** - 10Y at 4.31%
...
|-------|--------|-------|--------|----------|--------|
| **Apple** | AAPL | $260.48 | -1.28 | **-0.49%** | 🔴 |
| **Microsoft** | MSFT | $370.87 | +13.5 | **+3.64%** | 🟢 |
| **Alphabet** | GOOGL | $317.24 | +4.07 | **+1.28%** | 🟢 |
| **Amazon** | AMZN | $238.38 | +1.51 | **+0.63%** | 🟢 |
| **NVIDIA** | NVDA | $188.63 | +0.68 | **+0.36%** | 🟢 |
| **Meta** | META | $629.86 | +4.67 | **+0.74%** | 🟢 |
| **Tesla** | TSLA | $348.95 | +3.47 | **+0.99%** | 🟢 |

**Daily Analysis:**

The Magnificent 7 showed mostly positive results with 6 stocks advancing. MSFT led with +3.64% change. AAPL lagged at -0.49%.
...
|-------|-------|--------|----------|-------|
| **S&P 500** | 6,886 | +69.35 | **+1.02%** | 🟢 |
| **Nasdaq** | 23,183 | +280.85 | **+1.23%** | 🟢 |
| **Dow Jones** | 48,218 | +301.68 | **+0.63%** | 🟢 |
...
US markets showed strength with the S&P 500 up +1.02%. Korean markets pulled back with KOSPI down -0.86%.
...
|-------|--------|-------|--------|----------|-------|
| **Samsung** | 005930 | ₩201,000 | -5000.0 | **-2.43%** | 🔴 |
| **SK Hynix** | 000660 | ₩1,040,000 | +13000.0 | **+1.27%** | 🟢 |
| **Hyundai** | 005380 | ₩478,500 | -11000.0 | **-2.25%** | 🔴 |

**Analysis:** Korean stocks showed mixed performance with 2 of 3 stocks declining.

---

## 🎯 DAY-BY-DAY RECAP

### Tuesday, April 14, 2026: Global Market Rally

**Market Action:**
- 🇺🇸 Nasdaq +1.23%, S&P +1.02%, Dow +0.63%
- 🇺🇸 MSFT +3.64%
- 🇰🇷 KOSPI -0.86%, KOSDAQ +0.57%
- 💱 KRW -0.29% (weakness)
...
**US Markets:**
- **S&P 500:** Support 6,679 | Resistance 7,092
- **Nasdaq:** Support 22,488 | Resistance 23,879
- **Dow:** Support 46,771 | Resistance 49,664
...
**The Good:**
✅ US markets only down +1.02%, not catastrophic
✅ MSFT +3.64% relatively resilient

**The Bad:**
⚠️ Treasury yields rising (4.31%)
⚠️ KOSPI -0.86% down
...
**Coverage Period:** April 14, 2026 (Tuesday)  
**US Market Status:** After Hours
**Korean Market Status:** Pre-Market
