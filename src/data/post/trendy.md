...
excerpt: "트위터와 같은 소셜 미디어의 부상으로 '시대정신'의 변화를 관찰하는 것이 훨씬 더 쉬워졌다. 지난 몇 년 동안 유행처럼 번지는 다음과 같은 트렌드를 목격할 수 있다.    1. 최저임금 인상이 부작용이 없다는 주장.   2. 이자율이 낮을 때는 재정 적자가 커지더라도 크게 걱정할 필요가 없다는 주장.   3. 통화공급의 변화가 인플레이션에 영향을 미치..."
category: 'Macroeconomics'
tags: ['inflation', 'macroeconomics', 'policy', 'finance', 'labor']
---
