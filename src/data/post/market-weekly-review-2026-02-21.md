...
**The Big Story:**
The week belonged to Korean semiconductor stocks, with SK Hynix (+7.84%) and Samsung (+4.91%) posting their strongest weekly performances in months. Wednesday's Samsung breakout (+4.86%) and Thursday's SK Hynix surge (+6.15%) weren't random - they reflected:
...
4. **Valuation Sensitivity:** Most expensive names (MSFT, META) facing pressure
...
4. **Equity Implications:** Higher yields compete with stocks for capital
...
4. **Tesla Delivery Numbers:** Better-than-expected delivery data fueled +2.03% gain
...
4. **Currency Volatility:** Won's wild swing (1,448 → 1,345) suggests instability
...
4. **Currency Risk:** Won volatility impact
...
4. **Sector Balance:** Add defensive/value names
...
Favor quality semiconductors (Samsung, SK Hynix, NVIDIA), maintain discipline with stops, and keep powder dry for pullback opportunities. The trend is your friend, but don't chase extended moves.
