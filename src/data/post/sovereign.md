...
The goal is to ensure domestic firms have access to **training compute capacity**, which has become a key bottleneck in AI development.
...
This strategy reflects South Korea’s comparative advantage in **advanced manufacturing and industrial engineering**.
...
This positioning allows Korea to capture value both **upstream (hardware)** and **downstream (AI applications)**.
...
1. Compute infrastructure (GPUs, data centers)
2. Foundation models
3. AI-enabled industries
...
South Korea    Industrial AI + semiconductor integration
```

South Korea’s approach is distinctive because it focuses on **industrial AI integration rather than pure platform competition**.
